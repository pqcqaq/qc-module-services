...
public class User extends BaseEntity implements Serializable {
    ...
    @ColumnType(type = DataType.Varchar, comment = "手机号", nullable = false, length = 63)
    private String phone;
    @FromField(fieldPath = "avatarId")
    ...
    @OtODeepSearch(baseId = "avatarImageId", service = AttachmentsServiceImpl.class)
